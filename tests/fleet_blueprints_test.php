...
$required = ['name','class_code','class_name','role','tier','description','attack','defense','capacity','hull','shield','speed','cargo','sensor','power_grid','crew','armor','capacitor','signature','warp','evasion','drone_bandwidth','salvage','metal','crystal','energy','build_minutes'];
...
foreach ($blueprints as $blueprint) {
    ...
    foreach (['attack','defense','capacity','hull','shield','speed','cargo','sensor','power_grid','crew','armor','capacitor','evasion','drone_bandwidth','salvage','metal','crystal','energy','build_minutes'] as $field) if ((int)$blueprint[$field] <= 0) $positive = false;
}
